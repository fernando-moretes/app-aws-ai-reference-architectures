...
const hasRepoLink = links.some((link) => {
  const url = new URL(link, "https://ai-architectures.moretes.com");
  return url.protocol === "https:" && url.hostname === "github.com" && url.pathname === "/fernandofatech/aws-ai-reference-architectures";
});
...
const required = [
  ...
  [html.includes('rel="canonical" href="https://ai-architectures.moretes.com/"'), "index.html must include canonical domain"],
  ...
  [robots.includes("Sitemap: https://ai-architectures.moretes.com/sitemap.xml"), "robots.txt must point to sitemap"],
  [sitemap.includes("https://ai-architectures.moretes.com/"), "sitemap.xml must include canonical domain"],
